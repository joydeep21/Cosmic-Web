...
import MainAd from "../MobileScreen/MainAd.jsx";

export default function MostSearch({ details }) {
  return (
    <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="mt-11">
            <Image
              ...
              height={600}
              width={600}
              className="lg:h-[300px] lg:w-[743px] md:h-[110px] md:w-[220px] rounded-md"
            />
          </div>
        </div>
      </div>
      <div className="md:hidden block pb-20 px-4">
        <div className="flex flex-col gap-2 pt-2">
          <div className="flex justify-between gap-2">
            <h1 className="text-base font-serif italic">Most Searched</h1>
            <Link href={"/offer-zone"}>
